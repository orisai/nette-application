<script lang="ts">
    ...
    function handleKeyDown(event: KeyboardEvent) {
        // @todo vymyslet nejakou klavesovou zkratku pro inspect
...
<Toolbar>
    ...
    <!--	<ToolbarButton on:click={() => $mode = InspectorMode.LivePreview} active={$mode === InspectorMode.LivePreview}>-->
